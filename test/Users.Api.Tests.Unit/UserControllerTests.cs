...
public class UserControllerTests
{
    ...
    {
        // Arrange
        var user = new User { Id = Guid.NewGuid(), FullName = "Elise Blin" };
    ...
    {
        // Arrange
        var createUserRequest = new CreateUserRequest { FullName = "Elise Blin" };
        var user = new User { Id = Guid.NewGuid(), FullName = createUserRequest.FullName };
    ...
    [Fact]
    public async Task Create_ShouldReturnBadRequest_WhenCreateUserRequestIsNotValid()
    {
        // Arrange
